...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/css/flickity.css">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="home.php"><img src="<?=base_url()?>assets/img/logos/logo.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="<?=base_url()?>" style="color: #fed136">Home</a>
            </li>
            <li class="dropdown">
    ...
    <header class="masthead" >
      <div id="carouselIndicators" class="carousel slide" data-ride="carousel" data-interval="4000">
          ...
          <div class="carousel-item active">
            <img class="d-block w-100 " src="<?=base_url()?>assets/img/Home/itera.jpg" alt="First slide">
          ...
          <div class="carousel-item">
            <img class="d-block w-100 " src="<?=base_url()?>assets/img/Home/perpus1.jpg" alt="Second slide">
             <div id="carousel-caption" class="carousel-caption d-none d-md-block">
                 <div id="capt1">WELCOME TO FORPUS!</div>
                 <div id="capt2">SISTEM INFORMASI PERPUSTAKAAN ITERA</div>
              </div>
          ...
          <div class="carousel-item">
            <img class="d-block w-100 " src="<?=base_url()?>assets/img/Home/perpus5.jpg" alt="Third slide">
              <div id="carousel-caption" class="carousel-caption d-none d-md-block">
                 <div id="capt1">WELCOME TO FORPUS!</div>
                 <div id="capt2">SISTEM INFORMASI PERPUSTAKAAN ITERA</div>
              </div>
        ...
        <div class="carousel" data-flickity='{ "bgLazyLoad": 2 }'>
          ...
          <div>
            <a class="populer-link" data-toggle="modal" href="#populerModal1">
              <div class="carousel-cell" data-flickity-bg-lazyload="<?=base_url()?>assets/img/populer/solved-problems-in-geophysics.jpg"></div>
            </a>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="<?=base_url()?>assets/img/populer/geophysics.jpg" alt="">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="<?=base_url()?>assets/img/populer/calculus.jpg" alt="">
                  <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                  <ul class="list-inline">
                    <li>Tahun terbit : 2017</li>
                    <li>Penerbit: TPB</li>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="<?=base_url()?>assets/img/populer/02-full.jpg" alt="">
                  <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                  <ul class="list-inline">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <h2 class="text-uppercase">Project Name</h2>
                  <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                  <img class="img-fluid d-block mx-auto" src="<?=base_url()?>assets/img/populer/05-full.jpg" alt="">
                  <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                  <ul class="list-inline">
                    <li>Date: January 2017</li>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <h2 class="text-uppercase">Project Name</h2>
                  <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                  <img class="img-fluid d-block mx-auto" src="<?=base_url()?>assets/img/populer/06-full.jpg" alt="">
                  <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                  <ul class="list-inline">
                    <li>Date: January 2017</li>
                    <li>Client: Window</li>
  ...
  <!-- Contact -->
   ...
   <!-- Footer -->
    ...
    <script src="<?=base_url()?>assets/js/flickity.pkgd.js"></script>
    <script src="<?=base_url()?>assets/js/bg-lazyload.js"></script>
